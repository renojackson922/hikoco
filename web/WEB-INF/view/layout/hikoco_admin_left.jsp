...
<div class="pubg-left col-md-2" style="float:left;">
    <div class="text-center" style="border:1px solid #ddd; height:150px; margin-bottom:10px; padding:15px 5px 5px 5px;">
        ...
        <span class="span-loginInfo" style="font-size:10px; padding:0px 5px 0px 5px; background: #2897d3; color:#fff; border-radius:4px; display: inline-block;">관리자</span>
    </div>
