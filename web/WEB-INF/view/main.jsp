...
<div id="show">
    ...
    <section id="hikoco-sec3" class="text-center">
        ...
        <div class="sec3-wrapper container" style="display:inline-block; padding:17px 0 17px 0; width:100%">
            <%
                List<HashMap> ilistRyzen = (List<HashMap>)request.getAttribute("ilistRyzen");
            %>
            <div class="list-right">
                <ul class="list-ul">
                    <c:forEach var="i" items="${cntRyzen}">
                        <li class="list-action unselectable" onclick="window.location.href='item_detail.do?item_id=${i.item_id}'"> <!-- TEST -->
                            <figure>
