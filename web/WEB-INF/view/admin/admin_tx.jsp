            ...
            <div class="list-group" style="margin-bottom:15px;">
                ...
                <a href="#" class="list-group-item list-group-item-action">
                    <div class="text-left">
                        ...
                        <br>
                        <div class="col-md-12" style="display:block; float:left;"><span>구매품목: <strong>[HP] ProBook 450 G5 2XG23PA [기본제품] </strong></span>
                        </div>
                        <br>
                        ...
                        <div class="col-md-3" style="float:left;"><span>할인적용: <strong>TRUE</strong></span></div>
                        <br>
                        <hr style="margin:5px 0px 5px 0px;">
                ...
                <a href="#" class="list-group-item list-group-item-action">
                    <div class="text-left">
                        ...
                        <br>
                        <div class="col-md-12" style="display:block; float:left;"><span>구매품목: <strong>[GIGABYTE] GeForce GTX1080 Ti AORUS Xtreme D5X 11GB 워터블럭  </strong></span>
                        </div>
                        <br>
                        ...
                        <div class="col-md-3" style="float:left;"><span>할인적용: <strong>FALSE</strong></span></div>
                        <br>
                        <hr style="margin:5px 0px 5px 0px;">
                        <div class="col-md-3" style="float:left;"><span>상태: <strong>배송 중</strong></span></div>
                    </div>
                    ...
                    <div class="text-left">
                        ...
                        <div class="item-wrapper" style="height:70px ;">
                            ...
                            <div class="col-md-10" style="float:left; padding-left:0px;">
                                ...
                                <br>
                                <div class="col-md-3" style="float:left;"><span>등록가격: <strong>1,037,000원</strong></span>
                                </div>
                                <div class="col-md-3" style="float:left;"><span>구매가격: <strong>936,940원</strong></span>
                                </div>
                                <div class="col-md-3" style="float:left;"><span>할인적용: <strong>TRUE</strong></span></div>
                                <br>  <!-- new line -->
                        ...
                        <hr style="margin:5px 0px 5px 0px;">
                        <!-- 상태 -->
                        <div class="col-md-3" style="float:left; padding:0px;"><span>상태: <strong>거래완료</strong></span>
                        </div>
                    </div>
                </a>
                ...
                <a href="#" class="list-group-item list-group-item-action" style="background-color:#ddd;">
                    <div class="text-left">
                        ...
                        <div class="item-wrapper" style="height:70px ;">
                            ...
                            <div class="col-md-10" style="float:left; padding-left:0px;">
                                ...
                                <div class="col-md-12" style="display:block; float:left;">
                                    <span>구매품목: <strong><%=tdto.getItemname()%> </strong></span></div>
                                <br>
                                <div class="col-md-3" style="float:left;">
                                    <span>등록가격: <strong><%=itemcostOriginalStr%>원</strong></span></div>
                                <div class="col-md-3" style="float:left;">
                                    <span>구매가격: <strong><%=itemcostActualStr%>원</strong></span></div>
                                <div class="col-md-3" style="float:left;">
                                    <span>할인적용: <strong><%=isDiscountParse%></strong></span></div>
                                <br>  <!-- new line -->
                                <div class="col-md-3">기타: <strong><%=tdto.getExtrainfo()%>
                                </strong></div>
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="col-md-3" style="float:left; padding:0px;">
                            <span>상태: <strong><%=tdto.getShip_status()%></strong></span></div>
                    </div>
                </a>
                <% %>
            </div>
